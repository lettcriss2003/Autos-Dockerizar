...
export default function Page() {
    const validationSchema = Yup.object().shape({
        ...
        external_rol: Yup.string().required('Escoge el rol de la persona'),
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-outline mb-4">
                                            <div className="form-group">
                                                ...
                                                <select className='form-control' {...register('external_rol', { required: true })} onChange={(e) => setValue('external_rol', e.target.value)}>
                                                    <option value="">Seleccione un rol</option>
                                                    {Array.isArray(roles) && roles.map((mar, i) => (
                                                        <option key={i} value={mar.external_id}>
                                                            {mar.nombre}
                                                        </option>
                                                    ))}
                                                </select>
                                                {errors.external_rol && errors.external_rol.type === 'required' && <div className='alert alert-danger'>Seleccione un rol</div>}
                                            </div>
                                        </div>
